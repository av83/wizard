        ...
        (acts (list 
               (list :perm ':ADMIN 
                     ...
                     :fields (list 
                          ...
                          (list :btn "B8554" :perm 111 :value "Изменить пароль")))
               (list :perm ':ADMIN 
                     ...
                     :fields (list 
                          ...
                          (list :btn "B8555" :perm 111 :value "Создать новый аккаунт эксперта")))
               (list :perm ':ADMIN 
                     :title "Эксперты"
               ...
               (LOOP :FOR OBJ :BEING THE :HASH-VALUES :IN *USER* :USING (HASH-KEY
                     ...
                     :fields (list 
                          ...
                          (list :popbtn "P8556" 
                                ...
                                :fields (list 
                          (list :btn "B8557" :perm 111 :value "Подтверждаю удаление")))
                          (list :popbtn "P8558" 
                                ...
                                :fields (list 
                          (list :fld "PASSWORD" :perm 111 :typedata '(PSWD) :name "Пароль")
                          (list :btn "B8559" :perm 111 :value "Изменить пароль эксперта")))))
               (list :perm ':ADMIN 
       ...
       :COLLECT (CONS KEY OBJ))))
                     :fields (list 
                          ...
                          (list :popbtn "P8560" 
                                ...
                                :fields (list 
                          (list :btn "B8561" :perm 111 :value "Сделать добросовестным")))))))) 
    (show-acts acts)))

(restas:define-route admin-page/post ("/admin" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
("B8561" . ,(lambda () (APPROVE-SUPPLIER-FAIR)))
("B8559" . ,(lambda () (CHANGE-EXPERT-PASSWORD)))
("B8557" . ,(lambda () (DELETE-EXPERT)))
("B8555" . ,(lambda () (CREATE-EXPERT)))
("B8554" . ,(lambda () (CHANGE-SELF-PASSWORD)))))) 
       (activate acts)))
  ...
  (let ((session (hunchentoot:start-session))
        (acts (list 
               (list :perm '(AND :SELF :UNFAIR) 
                     ...
                     :fields (list 
                          (list :btn "B8562" :perm 111 :value "Отправить заявку на добросовестность")))
               (list :perm ':SELF 
               ...
               (LOOP :FOR OBJ :BEING THE :HASH-VALUES :IN *SUPPLIER-RESOURCE-PRICE* :USING (HASH-KEY
                     ...
                     :fields (list 
                          ...
                          (list :popbtn "P8563" 
                                ...
                                :fields (list 
                          (list :btn "B8564" :perm 111 :value "Удалить ресурс")))))
               (list :perm ':SELF 
...
(restas:define-route supplier-page/post ("/supplier" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
("B8564" . ,(lambda () (DEL-SUPPLIER-RESOURCE-PRICE)))
("B8562" . ,(lambda () (SUPPLIER-REQUEST-FAIR)))))) 
       (activate acts)))
               ...
               (list :perm '(AND :ACTIVE :FAIR) 
                     ...
                     :fields (list 
                          ...
                          (list :popbtn "P8565" 
                                ...
                                :fields (list 
                          (list :btn "B8566" :perm 111 :value "Участвовать в тендере")))))
               (list :perm ':OWNER 
                     ...
                     :fields (list 
                          (list :popbtn "P8567" 
                                ...
                                :fields (list 
                          (list :btn "B8568" :perm 111 :value "Подтверждаю отмену")))))))) 
    (show-acts acts)))

(restas:define-route tender-page/post ("/tender" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
("B8568" . ,(lambda () (CANCEL-TENDER)))
("B8566" . ,(lambda () (CREATE-OFFER)))))) 
       (activate acts)))
        ...
        (acts (list 
               ...
               (list :perm ':SELF 
                     ...
                     :fields (list 
                          ...
                          (list :fld "SUPPLIERS" :perm 111 :typedata '(LIST-OF-LINKS
                                                                       SUPPLIER) :name "Поставщики")
                          (list :btn "B8569" :perm 111 :value "Объявить тендер")))))) 
    (show-acts acts)))

(restas:define-route builder-page/post ("/builder" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
("B8569" . ,(lambda () (CREATE-TENDER)))))) 
       (activate acts)))
