        ...
        (acts (list
               (list :perm ':ADMIN
                     ...
                     :fields (list
                              ...
                              (list :btn "B6356" :perm 111 :value "Изменить пароль")))
               (list :perm ':ADMIN
                     ...
                     :fields (list
                              ...
                              (list :btn "B6357" :perm 111 :value "Создать новый аккаунт эксперта")))
               (list :perm ':ADMIN
                     :title "Эксперты"
                     ...
                     :fields (list
                              ...
                              (list :popbtn "P6358"
                                    ...
                                    :fields (list
                                             (list :btn "B6359" :perm 111 :value "Подтверждаю удаление")))
                              (list :popbtn "P6360"
                                    :value "Сменить пароль"
                                    :perm 111
                                    :title "Смена пароля эксперта"
                                    :fields (list
                                             (list :fld "PASSWORD" :perm 111 :typedata 'NIL :name "NIL")
                                             (list :btn "B6361" :perm 111 :value "Изменить пароль эксперта")))))
               (list :perm ':ADMIN
                     ...
                     :fields (list
                              ...
                              (list :popbtn "P6362"
                                    ...
                                    :fields (list
                                             (list :btn "B6363" :perm 111 :value "Сделать добросовестным"))))))))
    (show-acts acts)))
        ...
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              (list :fld "NAME" :perm 111 :typedata '(:STR) :name "ФИО")
                              (list :fld "LOGIN" :perm 111 :typedata '(:STR) :name "Логин")
                              (list :btn "B6364" :perm 111 :value "Страница эксперта"))))))
    (show-acts acts)))

(restas:define-route experts-page/post ("/expert" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B6364" . ,(lambda () (HUNCHENTOOT:REDIRECT
        ...
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              (list :fld "NAME" :perm 111 :typedata '(:STR) :name "Название организации")
                              (list :fld "LOGIN" :perm 111 :typedata '(:STR) :name "Логин")
                              (list :btn "B6365" :perm 111 :value "Страница поставщика"))))))
    (show-acts acts)))

(restas:define-route suppliers-page/post ("/supplier" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B6365" . ,(lambda () (HUNCHENTOOT:REDIRECT
  ...
  (let ((session (hunchentoot:start-session))
        (acts (list
               ...
               (list :perm '(AND :SELF :UNFAIR)
                     ...
                     :fields (list
                              (list :btn "B6366" :perm 111 :value "Отправить заявку на добросовестность")))
               (list :perm ':SELF
                     ...
                     :fields (list
                              ...
                              (list :popbtn "P6367"
                                    ...
                                    :fields (list
                                             (list :btn "B6368" :perm 111 :value "Удалить ресурс")))))
               (list :perm ':SELF
...
(restas:define-route supplier-page/post ("/supplier/:id" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B6366" . ,(lambda () (SUPPLIER-REQUEST-FAIR))))))
    (activate acts)))
        ...
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              ...
                              (list :fld "LOGIN" :perm 111 :typedata '(:STR) :name "Логин")
                              (list :btn "B6369" :perm 111 :value "Страница застройщика"))))))
    (show-acts acts)))

(restas:define-route builders-page/post ("/builder" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B6369" . ,(lambda () (HUNCHENTOOT:REDIRECT
                     ...
                     :fields (list
                              ...
                              (list :col "Тендеры застройщика" :perm 111
                                    ...
                                    :fields (list
                                             ...
                                             (list :btn "B6370" :perm 111 :value "Страница тендера")))
        ...
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              ...
                              (list :btn "B6372" :perm 111 :value "Страница тендера"))))))
    (show-acts acts)))

(restas:define-route tenders-page/post ("/tender" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B6372" . ,(lambda () (HUNCHENTOOT:REDIRECT
                                        (FORMAT NIL "/tender/~A" (GET-BTN-KEY (CAAR (FORM-DATA))))))))))
    (activate acts)))
               ...
               (list :perm 'NIL
                     ...
                     :fields (list
                              ...
                              (list :popbtn "P6373"
                                    ...
                                    :fields (list
                                             (list :btn "B6374" :perm 111 :value "Участвовать в тендере")))
                              (list :popbtn "P6375"
                                    :value "Отменить тендер"
                                    :perm 111
                                    :title "Действительно отменить?"
                                    :fields (list
                                             (list :btn "B6376" :perm 111 :value "Подтверждаю отмену"))))))))
    (show-acts acts)))
        ...
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              ...
                              (list :btn "B6377" :perm 111 :value "Страница ресурса"))))))
    (show-acts acts)))

(restas:define-route resources-page/post ("/resource" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B6377" . ,(lambda () (HUNCHENTOOT:REDIRECT
