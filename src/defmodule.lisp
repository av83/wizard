        ...
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              ...
                              (list :btn "B8903" :perm 111 :value "Показать ресурсы"))))))
    (show-acts acts)))

(restas:define-route catalog-page/post ("/catalog" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8903" . ,(lambda () (TO "/category/~A" (CAAR (FORM-DATA))))))))
    (activate acts)))
  ...
  (let ((session (hunchentoot:start-session))
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              (list :fld "NAME" :perm 111 :typedata '(:STR) :name "Имя")
                              (list :btn "B8904" :perm 111 :value "Показать ресурсы")))
               (list :perm ':ALL
                     :grid NIL
                     ...
                     :fields (list
                              ...
                              (list :btn "B8905" :perm 111 :value "Страница ресурса"))))))
    (show-acts acts)))

(restas:define-route category-page/post ("/category/:id" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8904" . ,(lambda () (TO "/category/~A" (CAAR (FORM-DATA)))))
                ("B8905" . ,(lambda () (TO "/resource/~A" (CAAR (FORM-DATA))))))))
    (activate acts)))
        ...
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              ...
                              (list :fld "RESOURCE-TYPE" :perm 111 :typedata '(:LIST-OF-KEYS RESOURCE-TYPES) :name "Тип")
                              (list :fld "UNIT" :perm 111 :typedata '(:STR) :name "Единица измерения")
                              (list :btn "B8907" :perm 111 :value "Страница категории")
                              (list :btn "B8908" :perm 111 :value "Страница ресурса"))))))
    (show-acts acts)))

(restas:define-route resources-page/post ("/resource" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8907" . ,(lambda () (HUNCHENTOOT:REDIRECT
                ...
                ("B8908" . ,(lambda () (TO "/resource/~A" (CAAR (FORM-DATA))))))))
    (activate acts)))

(restas:define-route resources-page/ajax ("/jg8906")
  (example-json
        ...
        (acts (list
               (list :perm ':ADMIN
                     ...
                     :fields (list
                              ...
                              (list :btn "B8909" :perm 111 :value "Изменить пароль")))
               (list :perm ':ADMIN
                     :grid NIL
                     ...
                     :fields (list
                              ...
                              (list :btn "B8910" :perm 111 :value "Создать новый аккаунт эксперта")))
               (list :perm ':ADMIN
                     :grid NIL
                     :title "Эксперты"
                     ...
                     :fields (list
                              ...
                              (list :popbtn "P8911"
                                    ...
                                    :fields (list
                                             (list :btn "B8912" :perm 111 :value "Подтверждаю удаление")))
                              (list :popbtn "P8913"
                                    ...
                                    :fields (list
                                             (list :fld "PASSWORD" :perm 111 :typedata '(:PSWD) :name "Пароль")
                                             (list :btn "B8914" :perm 111 :value "Изменить пароль эксперта")))
                              (list :btn "B8915" :perm 111 :value "Страница эксперта")))
               (list :perm ':ADMIN
                     :grid NIL
                     ...
                     :fields (list
                              ...
                              (list :popbtn "P8916"
                                    ...
                                    :fields (list
                                             (list :btn "B8917" :perm 111 :value "Сделать добросовестным"))))))))
    (show-acts acts)))

(restas:define-route admin-page/post ("/admin" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8909" . ,(lambda () (LET ((OBJ (CUR-USER)))
                ...
                ("B8912" . ,(lambda () (LET ((KEY (GET-BTN-KEY (CAAR (FORM-DATA)))))
                                         (REMHASH KEY *USER*)
                                         (HUNCHENTOOT:REDIRECT (HUNCHENTOOT:REQUEST-URI*)))))
                ("B8914" . ,(lambda () (LET ((OBJ (GETHASH (GET-BTN-KEY (CAAR (LAST (FORM-DATA)))) *USER*)))
                                         (WITH-OBJ-SAVE OBJ PASSWORD))))
                ("B8915" . ,(lambda () (TO "/expert/~A" (CAAR (FORM-DATA)))))
                ("B8917" . ,(lambda () (LET ((KEY (GET-BTN-KEY (CAAR (FORM-DATA)))))
        ...
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              (list :fld "NAME" :perm 111 :typedata '(:STR) :name "ФИО")
                              (list :fld "LOGIN" :perm 111 :typedata '(:STR) :name "Логин")
                              (list :btn "B8919" :perm 111 :value "Страница эксперта"))))))
    (show-acts acts)))

(restas:define-route experts-page/post ("/expert" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8919" . ,(lambda () (TO "/expert/~A" (CAAR (FORM-DATA))))))))
    (activate acts)))

(restas:define-route experts-page/ajax ("/jg8918")
  (example-json
        ...
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              (list :fld "NAME" :perm 111 :typedata '(:STR) :name "Название организации")
                              (list :fld "LOGIN" :perm 111 :typedata '(:STR) :name "Логин")
                              (list :btn "B8920" :perm 111 :value "Страница поставщика"))))))
    (show-acts acts)))

(restas:define-route suppliers-page/post ("/supplier" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8920" . ,(lambda () (TO "/supplier/~A" (CAAR (FORM-DATA))))))))
    (activate acts)))
        ...
        (acts (list
               (list :perm ':ADMIN
                     ...
                     :fields (list
                              (list :fld "LOGIN" :perm 111 :typedata '(:STR) :name "Логин")
                              (list :fld "PASSWORD" :perm 111 :typedata '(:PSWD) :name "Пароль")
                              (list :btn "B8921" :perm 111 :value "Изменить пароль")))
               (list :perm 'NIL
                     :grid NIL
                     :title "Поставщик"
                     :val (lambda () (GETHASH (CUR-ID) *USER*))
                     :fields (list
                              ...
                              (list :btn "B8922" :perm 111 :value "Сохранить")
                              (list :col "Список поставляемых ресурсов" :perm 111
                                    ...
                                    :fields (list
                                             ...
                                             (list :popbtn "P8923"
                                                   ...
                                                   :fields (list
                                                            (list :btn "B8924" :perm 111 :value "Удалить ресурс")))))
                              (list :popbtn "P8925"
                                    :value "Добавить ресурс"
                                    :perm 111
                                    :title "Добавление ресурса"
                                    :fields (list
                                             (list :btn "B8926" :perm 111 :value "Добавить ресурс")))
                              (list :col "Список заявок на тендеры" :perm 111
                                    ...
                                    :fields (list
                                             ...
                                             (list :btn "B8927" :perm 111 :value "Страница заявки")
                                             (list :popbtn "P8928"
                                                   :value "Удалить заявку"
                                                   :perm 111
                                                   :title "Удаление заявки"
                                                   :fields (list
                                                            (list :btn "B8929" :perm 111 :value "Удалить заявку")))))
                              (list :col "Список распродаж" :perm 111
                                    ...
                                    :fields (list
                                             ...
                                             (list :btn "B8930" :perm 111 :value "Страница распродажи")
                                             (list :popbtn "P8931"
                                                   :value "Удалить распродажу"
                                                   :perm 111
                                                   :title "Удаление распродажи"
                                                   :fields (list
                                                            (list :btn "B8932" :perm 111 :value "Удалить распродажу")))))
                              (list :popbtn "P8933"
                                    :value "Добавить распродажу"
                                    :perm 111
                                    :title "Добавление расподажи"
                                    :fields (list
                                             (list :btn "B8934" :perm 111 :value "Добавить распродажу")))))
               (list :perm '(AND :SELF :UNFAIR)
                     :grid NIL
                     :title "Отправить заявку на добросовестность"
                     :val (lambda () (GETHASH (CUR-ID) *USER*))
                     :fields (list
                              (list :btn "B8935" :perm 111 :value "Отправить заявку на добросовестность"))))))
    (show-acts acts)))

(restas:define-route supplier-page/post ("/supplier/:id" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8921" . ,(lambda () (LET ((OBJ (CUR-USER)))
                                         (WITH-OBJ-SAVE OBJ LOGIN PASSWORD))))
                ("B8922" . ,(lambda () (LET ((OBJ (GETHASH (CUR-ID) *USER*)))
                                         ...
                                         (HUNCHENTOOT:REDIRECT (HUNCHENTOOT:REQUEST-URI*)))))
                ("B8924" . ,(lambda () (DEL-INNER-OBJ (CAAR (FORM-DATA)) *SUPPLIER-RESOURCE-PRICE*
                ...
                ("B8926" . ,(lambda () (PROGN
                                         ...
                                         (HUNCHENTOOT:REDIRECT (HUNCHENTOOT:REQUEST-URI*)))))
                ("B8927" . ,(lambda () (TO "/offer/~A" (CAAR (FORM-DATA)))))
                ("B8929" . ,(lambda () (DEL-INNER-OBJ (CAAR (FORM-DATA)) *OFFER* (A-OFFERS (GETHASH (CUR-ID) *USER*)))))
                ("B8930" . ,(lambda () (TO "/sale/~A" (CAAR (FORM-DATA)))))
                ("B8932" . ,(lambda () (DEL-INNER-OBJ (CAAR (FORM-DATA)) *SALE* (A-SALES (GETHASH (CUR-ID) *USER*)))))
                ("B8934" . ,(lambda () (CREATE-SALE)))
                ("B8935" . ,(lambda () (PROGN
  ...
  (let ((session (hunchentoot:start-session))
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              (list :fld "NAME" :perm 111 :typedata '(:STR) :name "Распродажа")
                              (list :btn "B8936" :perm 111 :value "Страница распродажи"))))))
    (show-acts acts)))

(restas:define-route sales-page/post ("/sale" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8936" . ,(lambda () (TO "/sale/~A" (CAAR (FORM-DATA))))))))
    (activate acts)))
        ...
        (acts (list
               (list :perm 'NIL
                     ...
                     :fields (list
                              ...
                              (list :btn "B8937" :perm 111 :value "Сохранить")
                              (list :btn "B8938" :perm 111 :value "Удалить распродажу"))))))
    (show-acts acts)))

(restas:define-route sale-page/post ("/sale/:id" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8937" . ,(lambda () (SAVE-SALE)))
                ("B8938" . ,(lambda () (DELETE-SALE))))))
    (activate acts)))
        ...
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              ...
                              (list :fld "LOGIN" :perm 111 :typedata '(:STR) :name "Логин")
                              (list :btn "B8939" :perm 111 :value "Страница застройщика"))))))
    (show-acts acts)))

(restas:define-route builders-page/post ("/builder" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8939" . ,(lambda () (TO "/builder/~A" (CAAR (FORM-DATA))))))))
    (activate acts)))
        ...
        (acts (list
               (list :perm 'NIL
                     ...
                     :fields (list
                              ...
                              (list :btn "B8940" :perm 111 :value "Сохранить")
                              (list :col "Тендеры застройщика" :perm 111
                                    ...
                                    :fields (list
                                             ...
                                             (list :btn "B8941" :perm 111 :value "Страница тендера")))))
               (list :perm ':SELF
                     :grid NIL
                     ...
                     :fields (list
                              ...
                              (list :btn "B8942" :perm 111 :value "Объявить тендер (+)"))))))
    (show-acts acts)))

(restas:define-route builder-page/post ("/builder/:id" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8940" . ,(lambda () (LET ((OBJ (GETHASH (CUR-ID) *USER*)))
                                         (WITH-OBJ-SAVE OBJ NAME JURIDICAL-ADDRESS INN KPP OGRN BANK-NAME BIK
                                                        CORRESP-ACCOUNT CLIENT-ACCOUNT RATING))))
                ("B8941" . ,(lambda () (TO "/tender/~A" (CAAR (LAST (FORM-DATA))))))
                ("B8942" . ,(lambda () (LET ((ID (HASH-TABLE-COUNT *TENDER*)))
        ...
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              ...
                              (list :btn "B8943" :perm 111 :value "Страница тендера"))))))
    (show-acts acts)))

(restas:define-route tenders-page/post ("/tender" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8943" . ,(lambda () (TO "/tender/~A" (CAAR (FORM-DATA))))))))
    (activate acts)))
        ...
        (acts (list
               (list :perm 'NIL
                     ...
                     :fields (list
                              ...
                              (list :fld "INTERVIEW" :perm 111 :typedata '(:INTERVAL) :name "Срок проведения интервью")
                              (list :fld "RESULT" :perm 111 :typedata '(:INTERVAL) :name "Срок подведения итогов")
                              (list :btn "B8944" :perm 111 :value "Сохранить")
                              (list :col "Ресурсы тендера" :perm 111
                                    ...
                                    :fields (list
                                             (list :fld "NAME" :perm 111 :typedata '(:STR) :name "Название")
                                             (list :btn "B8945" :perm 111 :value "Удалить из тендера")
                                             (list :btn "B8946" :perm 111 :value "Страница ресурса")))
                              (list :popbtn "P8947"
                                    :value "Добавить ресурс"
                                    :perm 111
                                    ...
                                    :fields (list
                                             (list :col "Выберите ресурс" :perm 111
                                                   ...
                                                   :fields (list
                                                            (list :fld "NAME" :perm 111 :typedata '(:STR) :name "Наименование")
                                                            (list :btn "B8948" :perm 111 :value "Добавить ресурс")))))
                              (list :col "Документы тендера" :perm 111
                                    ...
                                    :fields (list
                                             (list :fld "NAME" :perm 111 :typedata '(:STR) :name "Название")
                                             (list :btn "B8949" :perm 111 :value "Удалить из тендера")
                                             (list :btn "B8950" :perm 111 :value "Страница документа")))
                              (list :popbtn "P8951"
                                    ...
                                    :fields (list
                                             (list :col "Выберите ресурс" :perm 111
                                                   ...
                                                   :fields (list
                                                            (list :fld "NAME" :perm 111 :typedata '(:STR) :name "Наименование")
                                                            (list :btn "B8952" :perm 111 :value "Добавить ресурс")))))
                              (list :col "Поставщики ресурсов" :perm 111
                                    ...
                                    :fields (list
                                             (list :fld "NAME" :perm 111 :typedata '(:STR) :name "Название")
                                             (list :btn "B8953" :perm 111 :value "Отправить приглашение")
                                             (list :btn "B8954" :perm 111 :value "Страница поставщика")))
                              (list :btn "B8955" :perm 111 :value "Добавить своего поставщика")
                              (list :col "Заявки на тендер" :perm 111
                                    :val (lambda () (CONS-INNER-OBJS *OFFER*
                                                                     (A-OFFERS
                                                                       ...
                                                                       *TENDER*))))
                                    :fields (list
                                             (list :btn "B8956" :perm 111 :value "Страница заявки")))
                              (list :popbtn "P8957"
                                    :value "Ответить заявкой на тендер"
                                    :perm 111
                                    :title "Выберите ресурсы"
                                    :fields (list
                                             (list :btn "B8958" :perm 111 :value "Участвовать в тендере")))
                              (list :popbtn "P8959"
                                    :value "Отменить тендер"
                                    :perm 111
                                    :title "Действительно отменить?"
                                    :fields (list
                                             (list :btn "B8960" :perm 111 :value "Подтверждаю отмену"))))))))
    (show-acts acts)))

(restas:define-route tender-page/post ("/tender/:id" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8944" . ,(lambda () (LET ((OBJ (GETHASH (CUR-ID) *TENDER*)))
                                         (WITH-OBJ-SAVE OBJ NAME ACTIVE-DATE ALL CLAIM ANALIZE INTERVIEW RESULT))))
                ("B8945" . ,(lambda () (LET ((ETALON (GETHASH (GET-BTN-KEY (CAAR (LAST (FORM-DATA)))) *RESOURCE*)))
                                         (SETF (A-RESOURCES (GETHASH (CUR-ID) *TENDER*))
                                               (REMOVE-IF #'(LAMBDA (X) (EQUAL X ETALON))
                                                          (A-RESOURCES (GETHASH (CUR-ID) *TENDER*))))
                                         (HUNCHENTOOT:REDIRECT (HUNCHENTOOT:REQUEST-URI*)))))
                ("B8946" . ,(lambda () (TO "/resource/~A" (CAAR (LAST (FORM-DATA))))))
                ("B8948" . ,(lambda () (PROGN
                                         (PUSH (GETHASH (GET-BTN-KEY (CAAR (LAST (FORM-DATA)))) *RESOURCE*)
                                               (A-RESOURCES (GETHASH (CUR-ID) *TENDER*)))
                                         (HUNCHENTOOT:REDIRECT (HUNCHENTOOT:REQUEST-URI*)))))
                ("B8949" . ,(lambda () (DELETE-DOC-FROM-TENDER)))
                ("B8950" . ,(lambda () (TO "/document/~A" (CAAR (LAST (FORM-DATA))))))
                ("B8952" . ,(lambda () (PROGN
                                         (PUSH (GETHASH (GET-BTN-KEY (CAAR (LAST (FORM-DATA)))) *RESOURCE*)
                                               (A-RESOURCES (GETHASH (CUR-ID) *TENDER*)))
                                         (HUNCHENTOOT:REDIRECT (HUNCHENTOOT:REQUEST-URI*)))))
                ("B8953" . ,(lambda () (DELETE-FROM-TENDER)))
                ("B8954" . ,(lambda () (TO "/supplier/~A" (CAAR (LAST (FORM-DATA))))))
                ("B8955" . ,(lambda () (ADD-DOCUMENT-TO-TENDER)))
                ("B8956" . ,(lambda () (TO "/offer/~A" (CAAR (LAST (FORM-DATA))))))
                ("B8958" . ,(lambda () (LET* ((ID (HASH-TABLE-COUNT *OFFER*))
                                              (OFFER
                ...
                ("B8960" . ,(lambda () (HUNCHENTOOT:REDIRECT (FORMAT NIL "/tender")))))))
    (activate acts)))
        ...
        (acts (list
               (list :perm ':ALL
                     ...
                     :fields (list
                              ...
                              (list :fld "TENDER" :perm 111 :typedata '(:LINK TENDER) :name "Тендер")
                              (list :btn "B8961" :perm 111 :value "Страница заявки"))))))
    (show-acts acts)))

(restas:define-route offers-page/post ("/offers" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8961" . ,(lambda () (TO "/offer/~A" (CAAR (FORM-DATA))))))))
    (activate acts)))
                     ...
                     :fields (list
                              ...
                              (list :col "Ресурсы оферты" :perm 111
                                    ...
                                    :fields (list
                                             (list :fld "RESOURCE" :perm 111 :typedata '(:LINK RESOURCE) :name "Ресурс")
                                             (list :fld "PRICE" :perm 111 :typedata '(:NUM) :name "Цена поставщика")
                                             (list :btn "B8962" :perm 111 :value "Удалить из оферты")
                                             (list :btn "B8963" :perm 111 :value "Страница ресурса")))
                              (list :popbtn "P8964"
                                    :value "Добавить ресурс"
                                    :perm 111
                                    :title "Выберите ресурсы"
                                                   ...
                                                   :fields (list
                                                            ...
                                                            (list :popbtn "P8965"
                                                                  ...
                                                                  :fields (list
                                                                           ...
                                                                           (list :btn "B8966" :perm 111 :value "Задать цену"))))))))))))
    (show-acts acts)))

(restas:define-route offer-page/post ("/offer/:id" :method :post)
  (let ((session (hunchentoot:start-session))
        (acts `(
                ("B8962" . ,(lambda () (DEL-INNER-OBJ (CAAR (LAST (FORM-DATA))) *OFFER-RESOURCE*
                                                      (A-RESOURCES (GETHASH (CUR-ID) *OFFER*)))))
                ("B8963" . ,(lambda () (TO "/resource/~A" (CAAR (LAST (FORM-DATA))))))
                ("B8966" . ,(lambda () (LET ((RES-ID (GET-BTN-KEY (CAAR (LAST (FORM-DATA)))))
